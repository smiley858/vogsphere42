...
/*   Updated: 2017/07/12 10:23:24 by gchojnac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	printf("test : %d \n", ft_atoi(strdup("-2147483648")));
	printf("test atoi: %d \n", atoi(strdup("-2147483648")));
	printf("test : %d \n", ft_atoi(strdup("--2147483648")));
	printf("test atoi: %d \n", atoi(strdup("--2147483648")));
	printf("test : %d \n", ft_atoi(strdup("+2147483647")));
	printf("test atoi: %d \n", atoi(strdup("+2147483647")));
	printf("test : %d \n", ft_atoi(strdup("2147483647")));
	printf("test atoi: %d \n", atoi(strdup("2147483647")));
	printf("test : %d \n", ft_atoi(strdup("0")));
	printf("test atoi: %d \n", atoi(strdup("0")));
